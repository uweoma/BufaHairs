...
-- CreateEnum
CREATE TYPE "HairTexture" AS ENUM ('STRAIGHT', 'BODY_WAVE', 'DEEP_WAVE', 'WATER_WAVE', 'LOOSE_WAVE', 'CURLY', 'KINKY_STRAIGHT', 'JERRY_CURL', 'NATURAL');
...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('ORDER_UPDATE', 'PAYMENT', 'PROMO', 'SYSTEM');
...
-- CreateIndex
CREATE INDEX "Product_texture_idx" ON "Product"("texture");
...
-- CreateIndex
CREATE INDEX "ProductVariant_length_idx" ON "ProductVariant"("length");
